...
@Repository
public class OwnerDaoDB implements OwnerDao{
    ...
    public Owner updateOwner(Owner owner) {
        final String UPDATE_OWNER = "UPDATE owners SET name =?, phone = ?, email =? WHERE id = ?";
    ...
    public Owner deleteOwnerById(int id) {
        ...
        final String DELETE_ANIMAL_BY_OWNER = "DELETE FROM animals WHERE ownerId = ?";
